...
<!-- wp:site-title {"textAlign":"center","style":{"typography":{"fontSize":"82px","fontStyle":"normal","fontWeight":"600","textTransform":"uppercase","textDecoration":"none"}},"textColor":"white"} /-->

<!-- wp:navigation {"ref":40,"textColor":"white","icon":"menu","layout":{"type":"flex","justifyContent":"center"},"style":{"spacing":{"blockGap":"3rem"}}} /--></div></div>
<!-- /wp:cover --></div>
<!-- /wp:group -->
